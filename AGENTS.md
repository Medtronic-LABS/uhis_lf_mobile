...
Parent context: `../AGENTS.md` (leapfrog-setup) and `../../AGENTS.md` (platform-setup).  
...
All code in this app must satisfy the **Engineering Design Standards** defined in `../../AGENTS.md` and `../AGENTS.md`. Key reminders specific to this app:
